...
<html lang="pt-br">
  ...
  <body>
        ...
        <a href="index.html" class="grid-3 logo">
          ...
          <nav class="grid-13 header_menu">
            <ul>
              ...
              <li>
                <div class="dropdown">
                  <button class="dropbtn menu-ativado">reutilização</button>
    ...
    <section class="introducao-interna interna-cat-embalagens">
      <div class="container">
        <h1 class="grid-16">garrafa pet</h1>
      </div>
    </section>
    <!-- FIM - INTRODUÇÃO -->
    ...
    <!-- INÍCIO - PRINCIPAIS ARTIGOS -->
      <section class="artigos">
        ...
        <!-- INÍCIO - ARTIGO 1 -->
          <div class="container mod-artigo art-pgs-sec">
            <div class="img-artigo">
            <a href=""><img src="./img/categoria-2/cat2-img-1.jpg" alt="Artigo 1" class="grid-5"></a>
            </div>

            <div class="text-artigo grid-11">
              <h3 class="categoria-artigo">CATEGORIA</h3>
              <a href="">
                <h2 class="titulo-artigo">Lorem ipsum dolor sit amet , consectetur adipiscing elit, sed do eiusmod tempor </h2>
              </a>
        ...
        <!-- INICIO - ARTIGO 2 -->
          <div class="container mod-artigo">
            <div class="img-artigo">
              <a href=""><img src="./img/categoria-2/cat2-img-2.jpg" alt="Artigo 2" class="grid-5"></a>
            </div>
        ...
        <!-- INICIO - ARTIGO 3 -->
          <div class="container mod-artigo">
            <div class="img-artigo">
              <a href=""> <img src="./img/categoria-2/cat2-img-3.jpg"  alt="Artigo 3" class="grid-5"></a>
            </div>
        ...
        <!-- INICIO - ARTIGO 4 -->
          <div class="container mod-artigo">
            <div class="img-artigo">
              <a href=""><img src="./img/categoria-2/cat2-img-4.jpg"  alt="Artigo 4" class="grid-5"></a>
            </div>
        ...
        <!-- INICIO - ARTIGO 5 -->
          <div class="container mod-artigo">
            <div class="img-artigo">
              <a href=""><img src="./img/categoria-2/cat2-img-2.jpg"  alt="Artigo 5" class="grid-5"></a>
            </div>
        ...
        <!-- INICIO - ARTIGO 6 -->
          <div class="container mod-artigo">
            <div class="img-artigo">
              <a href=""><img src="./img/categoria-2/cat2-img-6.jpg" alt="Artigo 6" class="grid-5"></a>
            </div>
        ...
        <!-- INICIO - ARTIGO 7 -->
          <div class="container mod-artigo">
            <div class="img-artigo">
              <a href=""><img src="./img/categoria-2/cat2-img-7.jpg" alt="Artigo 7" class="grid-5"></a>
            </div>
        ...
        <!-- INICIO - ARTIGO 8 -->
          <div class="container mod-artigo">
            <div class="img-artigo">
              <a href=""><img src="./img/categoria-2/cat2-img-8.jpg" alt="Artigo 8" class="grid-5"></a>
            </div>
        ...
        <!-- INICIO - ARTIGO 9 -->
          <div class="container mod-artigo">
            <div class="img-artigo">
              <a href=""><img src="./img/categoria-2/cat2-img-9.jpg" alt="Artigo 9" class="grid-5"></a>
            </div>
        ...
        <!-- FIM - ARTIGO 9 -->
         ...
         <div class="container mod-artigo">
          <div class="img-artigo">
            <a href=""><img src="./img/categoria-2/cat2-img-10.jpg" alt="Artigo 10" class="grid-5"></a>
          </div>
      ...
      <!-- FIM - ARTIGO 10 -->
        ...
        <!-- INÍCIO - NAV -->
          <nav class="container nav-cat-pgs">
            <ul class="grid-16">
              <li><a href="page-garrafa-pet-1.html">1</a></li>
              <li><a class="nav-cat-pgs nav-cat-pgs-ativo" href="page-garrafa-pet-2.html">2</a></li>
            </ul>
          </nav>
        <!-- FIM - NAV -->
