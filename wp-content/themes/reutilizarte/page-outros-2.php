...
<html lang="pt-br">
  ...
  <body>
    ...
    <section class="introducao-interna interna-cat-embalagens">
      <div class="container">
        <h1 class="grid-16">Outros Materiais</h1>
      </div>
    </section>
    <!-- FIM - INTRODUÇÃO -->
      ...
      <section class="artigos">
        ...
        <!-- INÍCIO - ARTIGO 1 -->
          <div class="container mod-artigo art-pgs-sec">
            ...
            <a href=""></a><img src="./img/categoria-2/cat2-img-1.jpg" alt="Artigo 1" class="grid-5"></a>
            </div>
      ...
      <!-- FIM - ARTIGO 10 -->
        ...
        <!-- INÍCIO - NAV -->
          <nav class="container nav-cat-pgs">
            <ul class="grid-16">
              <li><a href="page-outros-1.html">1</a></li>
              <li><a class="nav-cat-pgs nav-cat-pgs-ativo" href="page-outros-2.html">2</a></li>
            </ul>
          </nav>
        <!-- FIM - NAV -->
